  ...
  return (
    <div className="flex justify-center m-auto">
      <div className="h-[384px] w-[336px] rounded-xl shadow-md hover:shadow-2xl hover:duration-500 duration-500  ">
        <div
          className="bg-white w-[336] h-8 m-auto items-center flex justify-center text-zinc-400 space-x-2 text-3xl rounded-t-xl dark:bg-black
        ...
        <textarea
          ...
          className="text-xl text-zinc-700 bg-zinc-100 w-[336px] h-[352px] resize-none focus:outline-0 rounded-b-xl p-3 dark:bg-zinc-900 dark:text-zinc-100
