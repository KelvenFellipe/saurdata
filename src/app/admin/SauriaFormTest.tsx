...
export function SauriaTest({ click }: any) {
      ...
      <div className="p-4 space-y-5 bg-[#111316] text-white text-sm w-fit rounded-xl z-10 fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
        ...
        >
          <div className="space-x-4 justify-between flex">
            <select
              {...register("type")}
              className="bg-zinc-800 pl-2 w-[200px] h-9 border-r-8 border-transparent rounded-xl hover:bg-zinc-700/50 "
            >
            ...
            <select
              {...register("family")}
              className="bg-zinc-800 pl-2 w-[200px] border-r-8 border-transparent rounded-xl hover:bg-zinc-700/50 "
            >
              <option selected disabled className="bg-zinc-800 hover:bg-zinc-700/50">
                Family
              </option>
            ...
            <input
              className="bg-zinc-800 w-[200px] p-2 pl-2 hover:bg-zinc-700/50 rounded-xl hidden"
              placeholder="Family"
              required
              {...register("family")}
            />
