...
export function Notch() {
  ...
  return (
    <div className="">
      <div
        className="rounded-xl grid grid-cols-5 gap-3 p-3 bg-white text-zinc-400 
      shadow-md hover:shadow-xl hover:duration-300 duration-300 dark:bg-black justify-center text-3xl max-w-[240px] m-auto my-2 "
      >
        {notchData.map(item => (
